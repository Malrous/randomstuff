...
-- DEMINIFIED by hand
-- i tried to make it readable as much as possible with no optimization so if theres some errors dont criticize me please
-- view https://github.com/Malrous/randomstuff/new/main/LuarmorStuff/sdkapi-library-optimized.lua for an optimized and (mostly) renamed version of this
